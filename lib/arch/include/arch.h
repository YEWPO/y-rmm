...
#define RSI_SYSREG_ID_MASK		RSI_SYSREG_VAL(3, 7, 15, 0, 0)
#define RSI_SYSREG_ID		RSI_SYSREG_VAL(3, 0, 0, 0, 0)

#define RSI_SYSREG_ID_AA64PFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 4, 0)
#define RSI_SYSREG_ID_AA64PFR1_EL1	RSI_SYSREG_VAL(3, 0, 0, 4, 1)
#define RSI_SYSREG_ID_AA64ZFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 4, 4)
#define RSI_SYSREG_ID_AA64SMFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 4, 5)

#define RSI_SYSREG_ID_AA64DFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 5, 0)
#define RSI_SYSREG_ID_AA64DFR1_EL1	RSI_SYSREG_VAL(3, 0, 0, 5, 1)

#define RSI_SYSREG_ID_AA64AFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 5, 4)
#define RSI_SYSREG_ID_AA64AFR1_EL1	RSI_SYSREG_VAL(3, 0, 0, 5, 5)

#define RSI_SYSREG_ID_AA64ISAR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 6, 0)
#define RSI_SYSREG_ID_AA64ISAR1_EL1	RSI_SYSREG_VAL(3, 0, 0, 6, 1)

#define RSI_SYSREG_ID_AA64MMFR0_EL1	RSI_SYSREG_VAL(3, 0, 0, 7, 0)
#define RSI_SYSREG_ID_AA64MMFR1_EL1	RSI_SYSREG_VAL(3, 0, 0, 7, 1)
#define RSI_SYSREG_ID_AA64MMFR2_EL1	RSI_SYSREG_VAL(3, 0, 0, 7, 2)
...
#define RSI_SYSREG_TIMERS_MASK		RSI_SYSREG_VAL(3, 3, 15, 12, 0)
#define RSI_SYSREG_TIMERS			RSI_SYSREG_VAL(3, 3, 14, 0, 0)

#define RSI_SYSREG_TIMER_CNTP_TVAL_EL0	RSI_SYSREG_VAL(3, 3, 14, 2, 0)
#define RSI_SYSREG_TIMER_CNTP_CTL_EL0	RSI_SYSREG_VAL(3, 3, 14, 2, 1)
#define RSI_SYSREG_TIMER_CNTP_CVAL_EL0	RSI_SYSREG_VAL(3, 3, 14, 2, 2)
#define RSI_SYSREG_TIMER_CNTV_TVAL_EL0	RSI_SYSREG_VAL(3, 3, 14, 3, 0)
#define RSI_SYSREG_TIMER_CNTV_CTL_EL0	RSI_SYSREG_VAL(3, 3, 14, 3, 1)
#define RSI_SYSREG_TIMER_CNTV_CVAL_EL0	RSI_SYSREG_VAL(3, 3, 14, 3, 2)

#define RSI_SYSREG_ICC_PMR_EL1		RSI_SYSREG_VAL(3, 0, 4, 6, 0)
...
#define RSI_SYSREG_ICC_EL1_MASK		RSI_SYSREG_VAL(3, 3, 15, 8, 0)
#define RSI_SYSREG_ICC_EL1			RSI_SYSREG_VAL(3, 0, 12, 8, 0)

#define RSI_SYSREG_ICC_DIR			RSI_SYSREG_VAL(3, 0, 12, 11, 1)
#define RSI_SYSREG_ICC_SGI1R_EL1		RSI_SYSREG_VAL(3, 0, 12, 11, 5)
#define RSI_SYSREG_ICC_SGI0R_EL1		RSI_SYSREG_VAL(3, 0, 12, 11, 7)
